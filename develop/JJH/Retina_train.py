...
root='/data/ephemeral/home/level2-objectdetection-cv-10-1/dataset/'

# dataset config 수정
cfg.data.train.classes = classes
cfg.data.train.img_prefix = root
cfg.data.train.ann_file = root + 'train.json' # train json 정보
cfg.train_pipeline[2]['img_scale'] = (512,512) # Resize
...
cfg.seed = 2022
cfg.gpu_ids = [0]
cfg.work_dir = './work_dirs/retina_VarifocalLoss'

# cfg.model.roi_head.bbox_head.num_classes = 10
cfg.model.bbox_head.num_classes = 10
cfg.model.bbox_head.loss_cls.type = 'FocalLoss'
